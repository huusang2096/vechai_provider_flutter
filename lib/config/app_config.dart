...
class Colors {
  Color _mainColor = Color(0xFF28af4e);
  Color _mainDarkColor = Color(0xFF038d8d);
  Color _secondColor = Color(0xFF24388a);
  Color _secondDarkColor = Color(0xFF24388a);
  Color _accentColor = Color(0xFFADC4C8);
  Color _accentDarkColor = Color(0xFF525251);
  Color _categoryText = Color(0xFF000000);

  Color mainColor(double opacity) {
    return this._mainColor.withOpacity(opacity);
  }

  Color categoryColor(double opacity) {
    return this._categoryText.withOpacity(opacity);
  }
