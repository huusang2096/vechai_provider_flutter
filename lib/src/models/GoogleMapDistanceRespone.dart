...
class GoogleMapDistanceRespone {
  List<GeocodedWaypoint> geocodedWaypoints;
  List<Route> routes;
  String status;

  GoogleMapDistanceRespone({
    this.geocodedWaypoints,
    this.routes,
    this.status,
  });

  factory GoogleMapDistanceRespone.fromRawJson(String str) => GoogleMapDistanceRespone.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory GoogleMapDistanceRespone.fromJson(Map<String, dynamic> json) => GoogleMapDistanceRespone(
...
class GeocodedWaypoint {
  ...
  factory GeocodedWaypoint.fromRawJson(String str) => GeocodedWaypoint.fromJson(json.decode(str));
...
class Northeast {
  ...
  factory Northeast.fromRawJson(String str) => Northeast.fromJson(json.decode(str));
