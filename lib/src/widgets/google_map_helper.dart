...
import 'package:vecaprovider/config/decodePolyline.dart';
...
class GMapViewHelper {
  ...
  static Marker createMaker2 ({
    @required String markerIdVal,
    @required BitmapDescriptor icon,
    @required double lat,
    @required double lng, GestureTapCallback onTap,double bearing}){
