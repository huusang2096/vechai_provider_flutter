...
class OrderHostFinishedListItemWidget extends StatefulWidget {
  String heroTag;
  OrderModel order;

  OrderHostFinishedListItemWidget({Key key, this.heroTag, this.order})
      : super(key: key);

  @override
  _OrderHostFinishedListItemWidgetState createState() =>
      _OrderHostFinishedListItemWidgetState();
}

class _OrderHostFinishedListItemWidgetState
    extends State<OrderHostFinishedListItemWidget> with UIHelper {
  @override
    ...
    return Padding(
      ...
      child: InkWell(
        onTap: () => Navigator.of(context).pushNamed(
            RouteNamed.ORDERS_HOST_DETAIL_CATEGORY,
                  ...
                  children: <Widget>[
                    ListTile(
                      title: Text(
                          widget.order == null
                              ? ""
                              : '${widget.order.collector?.name ?? ''} - ${widget.order.collector?.id?.toString() ?? ''}',
